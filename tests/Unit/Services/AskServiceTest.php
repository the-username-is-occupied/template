...
test('ask method exists and has correct signature', function (): void {
...
test('ask method requires question parameter', function (): void {
    $reflection = new ReflectionMethod($this->askService, 'ask');
    $parameters = $reflection->getParameters();
...
test('ask method has nullable chat parameter', function (): void {
    $reflection = new ReflectionMethod($this->askService, 'ask');
    $parameters = $reflection->getParameters();
...
test('service has correct dependencies', function (): void {
