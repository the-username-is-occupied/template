...
return [
    ...
    /*
     * Embeddings must stay on OpenAI (or another explicit HTTP endpoint). Do not fall back to OPENAI_URL:
     * it is often pointed at FreeLLM/chat proxies while retrieval needs a stable embedding dimension.
     */
    'embedding_base_url' => env('HIPPORAG_EMBEDDING_BASE_URL', 'https://api.openai.com/v1'),
    'embedding_api_key' => env('HIPPORAG_EMBEDDING_API_KEY', env('OPENAI_API_KEY')),
    'score_threshold' => (float) env('HIPPORAG_SCORE_THRESHOLD', 0),
